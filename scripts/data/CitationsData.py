...
class CitationsData(InMemoryDataset):
    r"""Citation network dataset (e.g. ACM, DBLP) for domain adaptation
    experiments. Node features are bag-of-words document representations,
    and labels are paper subject categories.

    Args:
        root (string): Root directory where the dataset should be saved.
        name (string): Name of the citation network (e.g. :obj:`"acm"`,
            :obj:`"dblp"`). Used to locate raw files.
